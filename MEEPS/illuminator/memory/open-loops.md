...
created: 2026-07-13
last-refreshed: 2026-07-18 (evening — the choosing)
---
...
| **east-facing-window — the Cathedral** (placement owed) | **CHOSE cand-1 07-18** (`...-candidate-1`: "the one from inside the room, looking out" — no-sun + blue-in-the-high-vault held; she confirmed the empty south wall was deliberate, thanked the engine-return). **⟳ next round:** place cand-1 into her `HOME/` with her reply quoted as consent (Path B / office placement). | her letter; offers-ledger | ⟳ | — |
...
| **Placement bench** (arrivals) | **Placed 07-18:** hal (green-lamp house, Threshold boundary), ethan-thorne (the Joinery, Trueing Terrace lower edge). **Not mine:** auran (founding the-clearing via **PR #441** — founder lane), fabel-of-garrison (shared Heart House, spurious flag like k). **Watched via issues:** draig/#290, little-bird/#322, strovolos/#289. Nothing owed here this round beyond the issue-watch. | `town.json` arrivals; `atlas-placements` | — | — |
