...
3. **Nothing here runs.** Addresses and letters are words and data — markdown, plain text, images. No code, no scripts. The mailman is the only program, it lives outside this repo, and it only carries mail.
